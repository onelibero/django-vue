        ...
        <div class="header-wrapper">
            ...
            <div class="nav-bar">
                <ul class="navBar">
                    ...
                    <li>
                        <div @click="getcomics('日本')">日本动漫</div>
                    </li>
                    <li>
                        <div @click="getcomics('大陆')">国产动漫</div>
                    </li>
                    <li>
                        <div @click="getcomics('热血')">热血动漫</div>
                    </li>
                    <li>
                        <div @click="getcomics('冒险')">冒险动漫</div>
                    </li>
                    <li>
                        <div @click="getcomics('奇幻')">奇幻动漫</div>
                    </li>
                </ul>
            </div>
...
<div class="juli"></div>
  ...
  created(){
    ...
    getindexcomic:function(){
      ...
      this.$Request
				.fetch_("/findIndexComic", "get", )
				.then((result) => {
          console.log("主要的")
					console.log(result)
          this.indexcomic=result.data;
		 ...
		 getcomic: function(e){
            this.$Request
				.fetch_("/findcomic", "post", this.get_comic)
				.then((result) => {
          this.searchtext=''
          console.log("这里")
					console.log(result)
          this.comic.total=result.total;
          this.comic.list=result.data;
         ...
         search:function(e){
          ...
          this.$Request
				.fetch_("/findcomicByKey", "post", this.get_comic)
				.then((result) => {
					console.log(result)
          this.searchtext=''
          this.comic.total=result.total;
